...
INSERT INTO users(username, email, password) VALUES ('admin', 'admin@example.com', MD5('admin123'));
...
INSERT INTO contacts (full_name, phone, email, id_number, dob, gender, county)
VALUES
